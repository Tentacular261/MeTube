...
$result = $db->custom_sql("SELECT id,file,title,type,description,privacy,uploaded_by,friend FROM media LEFT JOIN (SELECT * FROM friends WHERE friend='$user') AS fre ON media.uploaded_by=fre.user WHERE id = \"".$getting."\"");
